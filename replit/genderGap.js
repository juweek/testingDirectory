...
------------------------
*/
var margin = { top: 10, right: 30, bottom: 0, left: 100 },
  width = 300 - margin.left - margin.right,
  height = 200 - margin.top - margin.bottom;

let allGroup = ["Boys", "Girls"]
...
d3.csv('https://html-css-js.jadesign.repl.co/data/belgium.csv').then(function(data) {
  createChart(svg, data, ["Boys", "Girls"]);
})
...
getCountriesData().then(function(countriesData) {
  for (var country in countriesData) {
    ...
    createChart(chartSVG, data, ["Boys", "Girls"]);
  }
});

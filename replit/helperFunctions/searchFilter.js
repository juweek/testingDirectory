...
------------------------
  */
function showClicked(currentClickedButtons, data, masterDataSet) {
  //clear out the div
  ...
  d3.select("#searchBarResults")
    ...
    .on("click", function(d) {
      ...
      let index = currentClickedButtons.indexOf(d);
      if (index > -1) {
...
function createSearchResults(searchValue, countriesList, resultsDropdown) {
  ...
  buttons.on('click', function() {
    ...
    showClicked(currentClickedButtons, data, masterDataSet);
  });
}
